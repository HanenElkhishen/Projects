...
extract_data_from_fixed_width = BashOperator(
    ...
    bash_command='cut -c58-62,63-67 /home/project/airflow/dags/finalassignment/staging/payment-data.txt | tr " " "," > /home/project/airflow/dags/finalassignment/staging/fixed_width_data.csv',
    dag=dag,
)
